...
export const TOOLS: Tool[] = [
  // HOSTING & DEPLOYMENT
  {
    ...
    logo: `<svg viewBox="0 0 76 65" fill="currentColor"><path d="M37.59.25l36.95 64H.64l36.95-64z"/></svg>`,
  },
  {
  ...
  },
  {
    ...
    plan: "Free", status: "live",
    logo: `<svg viewBox="0 0 100 60" fill="currentColor"><path d="M75 30c-1 0-3 0-4 1-2-9-10-16-19-16-8 0-15 5-18 13-1-1-3-1-4-1-7 0-13 6-13 13s6 13 13 13h45c5 0 10-4 10-9s-5-14-10-14z"/></svg>`,
  },
  ...
  // DATABASES
  {
    ...
    plan: "Launch", status: "live",
    logo: `<svg viewBox="0 0 100 100" fill="currentColor"><path d="M10 25c0-8 7-15 15-15h50c8 0 15 7 15 15v40L60 30v40H25c-8 0-15-7-15-15V25z"/></svg>`,
  },
  {
  ...
  // AUTH
  {
    ...
    plan: "Pro", status: "live",
    logo: `<svg viewBox="0 0 100 100" fill="currentColor"><circle cx="50" cy="40" r="15"/><path d="M20 80c5-15 17-22 30-22s25 7 30 22M30 70l8 8M70 70l-8 8"/></svg>`,
  },
  {
  ...
  },
  {
    ...
    plan: "Standard", status: "live",
    logo: `<svg viewBox="0 0 100 100" fill="currentColor"><path d="M5 60c0-30 25-55 55-55 19 0 35 9 45 24L29 95C16 87 7 75 5 60zM10 75l60 15c-20 5-45 0-60-15zM35 5L95 65c0-10-2-19-7-27L40 5h-5z"/></svg>`,
  },
  ...
  // MONITORING
  {
    ...
    plan: "Team", status: "live",
    logo: `<svg viewBox="0 0 100 100" fill="currentColor"><path d="M50 15L20 80h20c0-15 5-30 30-40-3-5-10-15-20-25z"/><path d="M50 30c15 25 25 35 25 50H60c0-10-3-15-10-25l-5 5h-5l5-15h5z" opacity=".6"/></svg>`,
  },
  {
    ...
    plan: "Pay-as-you-go", status: "live",
    logo: `<svg viewBox="0 0 100 100" fill="currentColor"><path d="M5 50L50 5v30l30-30v90H5V50z"/></svg>`,
  },
  {
  ...
  // EMAIL
  {
    ...
    plan: "Pro", status: "live",
    logo: `<svg viewBox="0 0 100 100" fill="currentColor"><path d="M15 25h70v50H15z" fill="none" stroke="currentColor" stroke-width="6"/><path d="M15 25l35 30 35-30" fill="none" stroke="currentColor" stroke-width="6"/></svg>`,
  },
  {
  ...
  // AI
  {
    ...
    plan: "Pay-as-you-go", status: "live",
    logo: `<svg viewBox="0 0 100 100" fill="currentColor"><path d="M27 20h15l25 60H53l-5-13H30l-5 13H10zM39 30l-7 22h13z"/></svg>`,
  },
  {
...
export const ACTIVITY: ActivityItem[] = [
  { tool: "vercel", text: "Deployment succeeded", repo: "hangar/web", time: "2m" },
  { tool: "github", text: "Pushed 3 commits to main", repo: "hangar/web", time: "8m" },
  { tool: "neon", text: "Branch dev/feat-auth ready", repo: null, time: "12m" },
  { tool: "sentry", text: "1 new issue in prod", repo: "hangar/api", time: "34m" },
  { tool: "stripe", text: "12 new subscriptions today", repo: null, time: "1h" },
  { tool: "linear", text: "HAN-247 marked done", repo: null, time: "2h" },
  { tool: "resend", text: "1,204 emails sent", repo: null, time: "3h" },
  { tool: "clerk", text: "47 new sign-ups", repo: null, time: "4h" },
];
